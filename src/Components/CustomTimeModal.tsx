            ...
            >
                ...
                <BottomSheetScrollView contentContainerStyle={tw`flex-1 bg-base_color  `}>
                    ...
                    <View style={tw`py-6 px-8`}>
                        <Text style={tw`text-center text-lg text-black font-PoppinsRegular`}>How may times you need to deliver this package ?</Text>
                    </View>
                    <View style={tw`px-6`}>
                        <Text style={tw`text-black font-PoppinsMedium mb-2 px-4`}>Time</Text>
                        <View style={tw`border border-gray-300 rounded-full px-4 py-2 z-[-1]`}>
                            <TextInput
                    ...
                    style={tw`px-4 py-6`}>
                        <View style={tw`bg-primary py-4 rounded-full`}>
                            <Text style={tw`text-center font-DegularDisplayDemoMedium text-xl text-white`}>Set time</Text>
                        </View>
