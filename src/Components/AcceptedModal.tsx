    ...
    <Modal transparent visible={visible} animationType="fade">
      ...
      >
        ...
        >
          ...
          <Text
            style={[
              tw`font-DegularDisplayDemoMedium text-center text-2xl text-black`,
              titleStyle,
            ]}
          >
            {title}
          ...
          <Text
            style={[
              tw`font-DegularDisplayDemoRegular text-center text-xl text-black`,
              subTitleStyle,
            ]}
          >
            {subtitle}
          ...
          <View style={tw`px-6 w-full`}>
            ...
            >
              <Text
                style={[
                  tw`text-center font-DegularDisplayDemoMedium text-white text-xl`,
                  btnTextStyle,
                ]}
              >
                {btnText}
