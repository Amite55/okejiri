      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          <Formik<PackageFormValues>
            ...
            initialValues={{
              image: servicePackages?.image
                ? {
                    uri: servicePackages?.image,
                    name: "existing.jpg",
                    type: "image/jpeg",
                  }
                : null,
                            ...
                            >
                              ...
                              <TouchableOpacity
                                ...
                                onPress={async () => {
                                  ...
                                  const response = await addServicePackageItem({
                                    item,
                                    package_id: id,
                                  }).unwrap();
                              ...
                              values.service_details.map((item, index) => (
                                ...
                                >
                                  ...
                                  <TouchableOpacity
                                    onPress={async () => {
                                      const deletedId =
                                        values.service_details_ids[index];
                                      if (deletedId) {
                                        const response =
                            ...
                            onChange={async (event, selectedDate) => {
                              ...
                              if (timeId) {
                                ...
                                if (
                                  editingField === "from" &&
                                  formated ===
                                    values.available_time_from[currentTimeIndex]
                                ) {
                                  return;
                                }
                                if (
                                  editingField === "to" &&
                                  formated ===
                                    values.available_time_to[currentTimeIndex]
                                ) {
                                  return;
                                }
                                const newFrom =
                                ...
                                if (toDate <= fromDate) {
                                  router.push({
                                    pathname: "/Toaster",
                                    params: {
                                      res: `"To" time must be after "From" time`,
                                    },
                                  });
