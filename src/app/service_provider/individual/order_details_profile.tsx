            ...
            { order && (
                <View>
                    ...
                    >
                        ...
                        <View
                            style={tw`flex-row py-2 px-7 justify-between items-center gap-2 rounded-full ${order.user?.kyc_status === "In Review" ? "bg-secondary" : order.kyc_status === "Verified" ? "bg-violet" : "bg-blueMagenta"}`}
                        >
